 ...
 * @public
 */
const PrismInit = function PrismInit({ manual, disableWorkerMessageHandler }) {
	 ...
	 *
	 * You obviously have to change this value before the automatic highlighting started.
	 *
	 * @default false
	 * @type {boolean}
	 */
